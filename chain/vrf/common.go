...
func create(ctx context.Context, vppConn api.Connection, networkService string, t *Map, isIPv6 bool) (uint32, bool, error) {
	t.mut.Lock()
	defer t.mut.Unlock()
...
func del(ctx context.Context, vppConn api.Connection, networkService string, t *Map, isIPv6, isClient bool) {
